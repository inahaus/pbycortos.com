...
class Securimage {
	...
	*/
	...
	function Securimage()
	{
		...
		echo "librerias: ".$config->get('librerias')."<br/>";
		// Set Default Values
		...
		$this->wordlist_file = $config->get('librerias').'/words/words.txt';
		$this->use_wordlist  = false;

		$this->gd_font_file  = $config->get('librerias').'/fonts/automatic.gdf';
		$this->use_gd_font   = false;
		$this->gd_font_size  = 24;
		$this->text_x_start  = 15;

		$this->ttf_file      = $config->get('librerias').'/AHGBold.ttf';
    ...
    $this->text_color       = new Securimage_Color(0x3d, 0x3d, 0x3d);
		...
		$this->signature_font  = $config->get('librerias').'/AHGBold.ttf';

		$this->audio_path   = $config->get('librerias').'/audio/';
		$this->audio_format = 'mp3';
		$this->session_name = '';
		$this->expiry_time  = 900;
		
		$this->sqlite_database = $config->get('librerias').'/database/securimage.sqlite';
