...
* @copyright Copyright (C) 2007 - 2010 Onírico Sistemas. Todos los derechos reservados.
* @version 0.1
...
HTML;
	...
	*/
	protected function eventDayFormat($day,$DMY)
	{
		...
		return "<div class='popup'><a href='index.php?controlador=tablon&amp;accion=verAnuncio&amp;fecha=$DMY' title='{$this->eventDay[$DMY]}'>$day</a></div>";
	}
