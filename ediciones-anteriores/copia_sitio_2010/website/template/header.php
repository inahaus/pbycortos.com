...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
		...
		<!--<ul id="menu">
		    ...
		    <li><a href="bases-y-condiciones.php" <?php if($_REQUEST['controlador']=='bases-y-condiciones'){?>class="active"<?}?>>Bases y Condiciones</a></li>
		    ...
		    <li><a href="ediciones-anteriores.php" <?php if($_REQUEST['controlador']=='ediciones-anteriores'){?>class="active"<?}?>>Ediciones anteriores</a></li>
