...
<h2><a href="index.php?controlador=jurado" title="volver">Volver</a></h2>
<h3><? if ($_REQUEST['accion'] == 'nuevaJurado' || $_REQUEST['accion'] == 'crearJurado') {
    echo "Crear Jurado";
} else {
    echo "Editar Jurado";
} ?></h3>
<form action="index.php?controlador=jurado&amp;accion=guardarJurado" method="post" class="jNice" enctype="multipart/form-data">
    <div class="portlet2">
        <div class="portlet2-header">Opciones Jurado</div>
        <div class="portlet2-content">
            <fieldset>
                <p><label>Nombre:</label><input type="text" class="text-long" name="nombre" value="<? echo htmlspecialchars($datos->nombre); ?>"/></p>
                <p><label>Edición a la que pertenece del jurado:</label>
